<template>
  <div class="read-content padd" :class="{nopadd:this.$route.path=='/reading'}" @touchstart="appTouchStar"
    ...
    <nav class="mui-bar mui-bar-tab" style="box-shadow: 0 0 1px rgba(0,0,0,0.3); z-index: 20000"
         v-if="this.$route.path!='/reading'">
      <span class="mui-tab-item"
            :class="{active:this.$route.query.bookListType=='home'||this.$route.path.indexOf('/home')>-1}"
            @click="routeGo('/home')">
        <span class="mui-icon mui-icon-home"></span>
        <span class="mui-tab-label">书架</span>
      </span>
      <span class="mui-tab-item"
            :class="{active:this.$route.query.bookListType=='recommend'||this.$route.path.indexOf('/recommend')>-1}"
            @click="routeGo('/recommend')">
        <span class="mui-icon mui-icon-paperplane"></span>
        <span class="mui-tab-label">推荐</span>
      </span>
      <span class="mui-tab-item"
            :class="{active:this.$route.query.bookListType=='classification'||this.$route.path.indexOf('/classification')>-1}"
            @click="routeGo('/classification')">
        <span class="mui-icon mui-icon-chatboxes-filled"></span>
        <span class="mui-tab-label">分类</span>
      </span>
      <span class="mui-tab-item"
            :class="{active:this.$route.query.bookListType=='search'||this.$route.path.indexOf('/search')>-1}"
            @click="routeGo('/search')">
